...
//	fprintf(stderr, "wordNum: %i \n",  wordNum);
//	fprintf(stderr, "size (emb dim): %i \n",  size);
...
//	fprintf(stderr, "Starting 1 ----- %s\n", argv[1]);
    
	solve("../data/evaluation_tests_word_embedding/ws/ws353.txt", argv[1]);
	solve("../data/evaluation_tests_word_embedding/ws/ws353_relatedness.txt", NULL);
	solve("../data/evaluation_tests_word_embedding/ws/ws353_similarity.txt", NULL);
